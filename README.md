...
3. Quantidade de vendas por Més: Analisando a quantidade de vendas realizadas em cada mês, podenos identificar sazonalidades no comportamento de compra dos clientes e planejar campanhas de marketing específicas para cada período.
